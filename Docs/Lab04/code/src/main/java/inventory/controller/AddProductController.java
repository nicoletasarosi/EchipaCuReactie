...
public class AddProductController implements Initializable, Controller {
    ...
    void handleDeleteProduct(ActionEvent event) {
        Item part = deleteProductTableView.getSelectionModel().getSelectedItem();
    ...
    void handleSaveProduct(ActionEvent event) throws IOException {
        ...
        try {
            List<ProductErrorMessage> errorMessages = Product.isValidProduct(name, Double.parseDouble(price), Integer.parseInt(inStock), Integer.parseInt(min), Integer.parseInt(max), addParts);
            if(!errorMessages.isEmpty()) {
                ...
                String errorMessage = "";
                //set errorMessage according to the errors
                for(ProductErrorMessage productErrorMessage : errorMessages) {
                    errorMessage += productErrorMessage.toString() + '\n';
                }
